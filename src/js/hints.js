export const hints = {
  ...
  "O": {
    "red": [ "Don't ask me personal questions",
  ...
  "C": {
    "red": [ "Don't criticize me, I will ask for input myself when I will need it.",
      "Keep your opinion to yourself! I am hut when others judge me, and that is important." ],
    "blue": [ "Before providing feedback, ask me if I am ready for it.",
      "I want to receive feedback, but not from everone - ask first." ],
    "green": [ "I am always ready for your input, be it criticism or praise.",
